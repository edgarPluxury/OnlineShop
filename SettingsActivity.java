...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        Toast.makeText(SettingsActivity.this, "Информация о профиле загружена успешно", Toast.LENGTH_SHORT).show();
        finish();
    ...
    private void UploadImage() {
        ...
        progressDialog.setTitle("Обновляем профиль");
        progressDialog.setMessage("Пожалуйста, подождите пока обновляется информация вашего аккаунта");
